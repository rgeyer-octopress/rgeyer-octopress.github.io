...
[bash]grails generate-manager[/bash]
...
<p class="filename">SecurityConfig.groovy</p>
[groovy highlight="14,17,18"]
security {
...
<b>Securing the Security Controllers</b>
...
<p class="filename">UserController.groovy</p>
[groovy highlight="1,3"]
...
[/groovy]
<p class="filename">RoleController.groovy</p>
[groovy highlight="1,3"]
import org.codehaus.groovy.grails.plugins.springsecurity.Secured;
...
<b>Enabling the @Secured annotation</b>
...
<p class="filename">BootStrap.groovy</p>
[groovy]
class BootStrap {
